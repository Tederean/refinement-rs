...
impl<T: Clone, P: Predicate<T>> Clone for Refinement<T, P> {
    fn clone(&self) -> Self {
        Self(self.0.clone(), self.1.clone())
    }
}

impl<T: Copy, P: Predicate<T>> Copy for Refinement<T, P> {}
...
impl<T: Serialize + for<'de> Deserialize<'de>, P> Add<T> for Refinement<T, P>
where
    T: Add<Output = T>,
    P: Predicate<T>,
{
...
impl<T: Serialize + for<'de> Deserialize<'de>, P> Rem<T> for Refinement<T, P>
where
    T: Rem<Output = T>,
    P: Predicate<T>,
{
